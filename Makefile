...
#    Updated: 2018/05/01 15:50:22 by amyburgh         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBC = ft_memset.c	ft_bzero.c	ft_memcpy.c	ft_memccpy.c	ft_memmove.c	ft_memchr.c	ft_memcmp.c	\
	   ...
	   ft_lstnew.c   ft_lstdelone.c  ft_lstdel.c ft_lstadd.c ft_lstaddend.c  ft_lstiter.c    ft_lstmap.c \
	   ft_wordcount.c   ft_digitcount.c ft_swap.c   ft_strrev.c ft_strndup.c    ft_lstsize.c    ft_lstclear.c \
